...
- **원작 룰**: watersnake
- **엔진 베이스**: asacolips 13th Age (MIT) — `licenses/` 및 본 README 하단의 라이선스 고지 유지
- **대상 Foundry 버전**: v13 (verified 13.351)
- **성격**: 비상업·커뮤니티용. 13th Age 트레이드마크/OGL/SRD 컴펜디움 및 Foundry 전용 아이콘 자산은 **단계적으로 제거·교체 예정**이며, 그 전까지 공개 배포는 보류합니다.

> ⚠️ 개발 중(Phase 0: 정체성 리네임 완료). 데이터 모델·시트·판정·컴펜디움은 이후 단계에서 성배전쟁 룰에 맞게 개조됩니다.

---

<details>
<summary>원본 13th Age README / 라이선스 고지 (보존)</summary>
