export class EffectArchmageSheet extends foundry.applications.sheets.ActiveEffectConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      template: "systems/watersnake-grail-war/templates/active-effects/effect.html",
      width: 560,
      height: 550,
  ...
  async getData(options) {
    ...
    context.durationOptions = CONFIG.HOLYGRAILWAR.effectDurationTypes;
  ...
  async _updateObject(event, formData) {
    ...
    addChange("system.attributes.init.value");
