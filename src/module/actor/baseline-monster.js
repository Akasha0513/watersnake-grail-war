export async function baselineMonsterDialog () {
  const content = await foundry.applications.handlebars.renderTemplate(
    'systems/watersnake-grail-war/templates/dialog/baseline-monster-dialog.html'
  )
  ...
  new foundry.applications.api.DialogV2({
    ...
    submit: async ({ level, strength }) => {
      ...
      const { baselineMonsterStats } = CONFIG.HOLYGRAILWAR
      ...
      const actor = await game.holygrailwar.ActorArchmage.create({
