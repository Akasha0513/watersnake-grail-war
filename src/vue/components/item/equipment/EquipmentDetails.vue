    ...
    <div class="form-group">
      ...
      <div class="field">
        <select name="system.chackra" v-model="item.system.chackra">
          ...
          <option v-for="(label, value) in CONFIG.HOLYGRAILWAR.chakraSlots" :key="value" :value="value">{{ game.i18n.localize(label) }}</option>
        </select>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="field">
        <select name="system.tier" v-model="item.system.tier">
          <option value="">{{ game.i18n.localize('ARCHMAGE.noneOption') }}</option>
          <option v-for="(label, value) in CONFIG.HOLYGRAILWAR.featTiers" :key="value" :value="value">{{ label }}</option>
        </select>
      </div>
    </div>
