    ...
    <div class="form-group">
      ...
      <div class="field">
        <select name="system.actionType.value" v-model="item.system.actionType.value">
          ...
          <option v-for="(label, value) in CONFIG.HOLYGRAILWAR.actionTypes" :key="value" :value="value">{{ label }}</option>
        </select>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="field">
        <select name="system.powerSource.value" v-model="item.system.powerSource.value">
          <option value="">{{ game.i18n.localize('ARCHMAGE.noneOption') }}</option>
          <option v-for="(label, value) in CONFIG.HOLYGRAILWAR.powerSources" :key="value" :value="value">{{ label }}</option>
        </select>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="field">
        <select name="system.powerType.value" v-model="item.system.powerType.value">
          <option value="">{{ game.i18n.localize('ARCHMAGE.noneOption') }}</option>
          <option v-for="(label, value) in CONFIG.HOLYGRAILWAR.powerTypes" :key="value" :value="value">{{ label }}</option>
        </select>
      </div>
    </div>
  </fieldset>
    ...
    <div class="form-group">
      ...
      <div class="field">
        <select name="system.powerUsage.value" v-model="item.system.powerUsage.value">
          <option value="">{{ game.i18n.localize('ARCHMAGE.noneOption') }}</option>
          <option v-for="(label, value) in CONFIG.HOLYGRAILWAR.powerUsages" :key="value" :value="value">{{ label }}</option>
        </select>
      </div>
    </div>
