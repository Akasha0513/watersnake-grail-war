  ...
  <section class="section section--sidebar flexcol filters">
    ...
    <div class="unit unit--input">
      ...
      <Multiselect
        ...
        :searchable="false"
        :create-option="false"
        :options="CONFIG.HOLYGRAILWAR.powerTypes"
      />
    </div>
    ...
    <div class="unit unit--input">
      ...
      <Multiselect
        ...
        :searchable="false"
        :create-option="false"
        :options="CONFIG.HOLYGRAILWAR.powerUsages"
      />
    </div>
    ...
    <div class="unit unit--input">
      ...
      <Multiselect
        ...
        :searchable="false"
        :create-option="false"
        :options="CONFIG.HOLYGRAILWAR.actionTypes"
      />
    </div>
  ...
  methods: {
     ...
     */
     getActionShort(actionType) {
      if (CONFIG.HOLYGRAILWAR.actionTypesShort[actionType]) {
        return CONFIG.HOLYGRAILWAR.actionTypesShort[actionType];
      }
      return CONFIG.HOLYGRAILWAR.actionTypesShort['standard'];
    },
    /**
